...
class Pos_model extends CI_Model
{
    ...
    {
        $this->db->select('sales.*, users.username,erp_tax_rates.name AS tax,erp_payments.paid_by,erp_users.phone,erp_payments.cheque_no,erp_payments.cc_no,erp_payments.cc_type,erp_warehouses.name AS ware, erp_payments.pos_balance, erp_payments.pos_paid_other_rate,user2.username AS customer_name, companies.invoice_footer');
        $this->db->join('companies', 'sales.biller_id = companies.id', 'left');
